...
# make router
hull_params = hull_args()
hull_params.q_capacity = 4096
hull_params.GAMMA = 950
hull_params.mark_threshold = 3300

#hull_params.K_threshold = 65  # from Alizadeh et al. SIGCOMM 2010. this might not be correct in general
hull_params.K_threshold = 20 # for 1 Gbit/s

rtr = HULLRouter(0, hull_params, dropper, state.queue_bank_stats)
