...
emulation: emulation_test.o emulation.o endpoint.o router.o packet.o port.o drop_tail.o
	$(CC) $< emulation.o endpoint.o router.o packet.o port.o drop_tail.o -o $@ $(LDFLAGS)
